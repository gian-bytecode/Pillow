...
class TestLowLevelGPU:
    ...
    def test_from_bytes_L_roundtrip(self):
    ...
    def test_convert_RGBA_to_L(self):
...
class TestGpuImage:
    ...
    def test_from_cpu_to_cpu_RGB(self):
    ...
    def test_from_cpu_to_cpu_RGBA(self):
    ...
    def test_from_cpu_to_cpu_L(self):
...
class TestGpuNewKernels:
    ...
    def test_reduce_3x(self):
        ...
        assert abs(result.getpixel((16, 16)) - 128) <= 1
